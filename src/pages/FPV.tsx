...
const categories = [
  {
    name: "套装系列",
    description: "完整FPV飞行套装，开箱即飞，适合入门玩家快速上手",
    icon: Package,
  ...
  {
    name: "竞速系列",
    description: "专业竞速穿越机，极致速度体验，为赛事而生",
    icon: Gauge,
  ...
  {
    name: "花飞系列",
    description: "自由式花飞穿越机，灵活机动，适合特技飞行",
    icon: Flower2,
...
const hotProducts = [
  {
    name: "CL-R5 竞速套装",
    category: "竞速系列",
    description: "专业竞速级FPV无人机，5寸机架，适合赛事训练和极限飞行。",
    specs: ["最高时速: 160km/h", "电机: 2806.5 1300KV", "图传延迟: <28ms"],
    image: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600&q=80",
    price: "¥2,999",
  },
  {
    name: "CL-F3 花飞入门版",
    category: "花飞系列",
    description: "3寸花飞穿越机，室内外皆可飞行，适合新手练习特技。",
    specs: ["轴距: 140mm", "重量: 180g", "续航: 8分钟"],
    image: "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=600&q=80",
    price: "¥1,299",
  },
  {
    name: "CL-LR7 远航版",
    category: "远航系列",
    description: "7寸长续航穿越机，搭载高效动力系统，探索更远距离。",
    specs: ["续航: 35分钟", "图传距离: 15km", "载重: 500g"],
    image: "https://images.unsplash.com/photo-1506947411487-a56738267384?w=600&q=80",
    price: "¥4,599",
  },
];
...
const articles = [
  {
    title: "FPV穿越机入门全解析 | 新手如何玩转速度与激情",
    excerpt: "在无人机的众多类型中，FPV穿越机凭借独特的沉浸式体验和极速飞行的爽感，迅速成为无人机爱好者的新宠...",
    image: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=400&q=80",
    date: "2025-08-15",
  },
  {
    title: "穿越机FPV | 探索极限飞行的无限可能",
    excerpt: "随着无人机技术的飞速发展，穿越机FPV逐渐成为飞行爱好者和极限运动者的热宠...",
    image: "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=400&q=80",
    date: "2025-05-20",
  },
  {
    title: "穿越机 | 释放视角的边界，让飞行成为创意的新引擎",
    excerpt: "在视觉至上的短视频时代，一段震撼、独特的镜头，往往比千言万语更能打动人心...",
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-16 md:pt-20">
        ...
        <section className="py-20 bg-background">
          <div className="container-custom">
            <div className="text-center mb-14">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">产品分类</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                根据飞行风格和使用场景，选择最适合您的FPV穿越机
              </p>
        ...
        <section className="py-20 bg-secondary">
          <div className="container-custom">
            <div className="text-center mb-14">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">热门产品</h2>
        ...
        <section className="py-16 bg-background">
          <div className="container-custom">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">配件周边</h2>
              <div className="w-20 h-1 bg-accent mx-auto rounded-full" />
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {accessories.map((item, index) => (
                <div
                  key={index}
                  className="p-4 bg-card rounded-xl shadow-card hover:shadow-card-hover transition-all text-center group cursor-pointer"
                >
                  <span className="text-sm font-medium text-card-foreground group-hover:text-accent transition-colors block mb-1">
                    {item.name}
                  </span>
        ...
        <section className="py-20 bg-secondary">
          <div className="container-custom">
            <div className="text-center mb-14">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">FPV资讯</h2>
              <p className="text-muted-foreground">了解最新FPV技术动态和飞行技巧</p>
              <div className="w-20 h-1 bg-accent mx-auto rounded-full mt-4" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {articles.map((article, index) => (
                <div
                  key={index}
                  className="group bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover transition-all cursor-pointer"
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-card-foreground mt-2 mb-3 group-hover:text-accent transition-colors line-clamp-2">
                      {article.title}
                    </h3>
