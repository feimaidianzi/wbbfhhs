  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-16 md:pt-20">
        ...
        {/* HD-1400-A150 Strategic Advantage Section */}
        {isHDA150 && (
          <section className="py-16 bg-background">
            <div className="container-custom">
              <div className="text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">{t('digitalFpv.h.a150.strategic.title')}</h2>
                <p className="text-muted-foreground max-w-3xl mx-auto">{t('digitalFpv.h.a150.strategic.desc')}</p>
                <div className="w-20 h-1 bg-accent mx-auto rounded-full mt-4" />
              </div>
              <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  ...
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.a150.strategic.sensitivity')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.a150.strategic.sensitivityDesc')}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  <div className="w-16 h-16 bg-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Antenna className="w-8 h-8 text-accent" />
                  </div>
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.a150.strategic.maritime')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.a150.strategic.maritimeDesc')}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  <div className="w-16 h-16 bg-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Target className="w-8 h-8 text-accent" />
                  </div>
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.a150.strategic.redundancy')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.a150.strategic.redundancyDesc')}</p>
                </div>
              </div>
            </div>
          </section>
        ...
        {/* HD-1400-A150 Cross-Link: Strategic Platform */}
        {isHDA150 && (
          <section className="py-16 bg-accent/5">
            <div className="container-custom">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">{t('digitalFpv.h.a150.crossLink.title')}</h2>
                <div className="w-20 h-1 bg-accent mx-auto rounded-full mb-6" />
                <p className="text-muted-foreground leading-relaxed mb-8">
                  {t('digitalFpv.h.a150.crossLink.desc')}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                  <Link to="/products/swarm">
                    <Button variant="outline" className="gap-2 px-6 py-5">
                      <Users className="w-5 h-5" />
                      {t('digitalFpv.h.a150.crossLink.swarm')}
                    </Button>
                  </Link>
                  <Link to="/products/logistics">
                    <Button variant="outline" className="gap-2 px-6 py-5">
                      <Truck className="w-5 h-5" />
                      {t('digitalFpv.h.a150.crossLink.logistics')}
                    </Button>
                  </Link>
                  <Link to="/products/tethered">
                    <Button variant="outline" className="gap-2 px-6 py-5">
        ...
        {/* HD-4000-B150 Strategic Advantage Section */}
        {isHD4000B150 && (
          <section className="py-16 bg-background">
            <div className="container-custom">
              <div className="text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">{t('digitalFpv.h.4000b150.strategic.title')}</h2>
                <p className="text-muted-foreground max-w-3xl mx-auto">{t('digitalFpv.h.4000b150.strategic.desc')}</p>
                <div className="w-20 h-1 bg-accent mx-auto rounded-full mt-4" />
              </div>
              <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  ...
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.4000b150.strategic.spectrum')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.4000b150.strategic.spectrumDesc')}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  <div className="w-16 h-16 bg-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Target className="w-8 h-8 text-accent" />
                  </div>
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.4000b150.strategic.directivity')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.4000b150.strategic.directivityDesc')}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-card text-center">
                  <div className="w-16 h-16 bg-accent/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Zap className="w-8 h-8 text-accent" />
                  </div>
                  <h4 className="font-bold mb-2">{t('digitalFpv.h.4000b150.strategic.throughput')}</h4>
                  <p className="text-muted-foreground text-sm">{t('digitalFpv.h.4000b150.strategic.throughputDesc')}</p>
                </div>
              </div>
            </div>
          </section>
        ...
        {isHD4000B150 && (
          <section className="py-16 bg-accent/5">
            <div className="container-custom">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">{t('digitalFpv.h.4000b150.crossLink.title')}</h2>
                <div className="w-20 h-1 bg-accent mx-auto rounded-full mb-6" />
                <p className="text-muted-foreground leading-relaxed mb-8">
                  {t('digitalFpv.h.4000b150.crossLink.desc')}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                  <Link to="/products/accessories/digital-fpv/hd-4000-a150">
                    <Button variant="outline" className="gap-2 px-6 py-5">
                      <Radio className="w-5 h-5" />
                      {t('digitalFpv.h.4000b150.crossLink.a150')}
                    </Button>
                  </Link>
                  <Link to="/products/swarm">
                    <Button variant="outline" className="gap-2 px-6 py-5">
                      <Users className="w-5 h-5" />
                      {t('digitalFpv.h.4000b150.crossLink.swarm')}
                    </Button>
                  </Link>
                  <Link to="/products/accessories/digital-fpv/hd-hb150">
                    <Button variant="outline" className="gap-2 px-6 py-5">
                      <Antenna className="w-5 h-5" />
                      {t('digitalFpv.h.4000b150.crossLink.hb150')}
                    </Button>
                  </Link>
                </div>
              </div>
