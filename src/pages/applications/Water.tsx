...
const features = [
  { icon: Droplets, title: "河道巡检", description: "无人机快速覆盖河道全线，实时监测水质和堤坝状况" },
  { icon: Shield, title: "水库监测", description: "对水库大坝进行定期巡检，及时发现安全隐患" },
  { icon: Zap, title: "防汛抗旱", description: "汛期实时监测水位变化，为防汛决策提供数据支持" },
  { icon: Eye, title: "水资源调查", description: "航拍测绘水域面积，调查水资源分布情况" },
];
      ...
      <main className="pt-16 md:pt-20">
        ...
        <section className="relative h-[350px] md:h-[450px] overflow-hidden">
          ...
          <div className="relative container-custom h-full flex items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground mb-4">水利</h1>
        ...
        <section className="py-16 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">获取水利行业解决方案</h2>
