...
const features = [
  { icon: Shield, title: "应急救援", description: "快速响应突发事件，提供空中搜救和物资投送" },
  { icon: Eye, title: "现场监控", description: "实时传输现场画面，为指挥决策提供第一手资料" },
  { icon: Radio, title: "通信中继", description: "搭建临时通信网络，保障应急通信畅通" },
  { icon: Zap, title: "灾情评估", description: "快速获取灾区影像，评估灾情损失程度" },
];
      ...
      <main className="pt-16 md:pt-20">
        <section className="relative h-[350px] md:h-[450px] overflow-hidden">
          ...
          <div className="relative container-custom h-full flex items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground mb-4">应急</h1>
        ...
        <section className="py-16 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">获取应急救援解决方案</h2>
