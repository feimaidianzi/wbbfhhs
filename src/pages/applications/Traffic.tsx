...
const features = [
  { icon: Car, title: "交通流量监控", description: "实时监测道路交通流量，为交通管理提供数据支持" },
  { icon: Eye, title: "事故快速响应", description: "第一时间抵达事故现场，提供空中视角支持救援" },
  { icon: Zap, title: "道路巡检", description: "高效巡检道路状况，及时发现路面损坏和安全隐患" },
  { icon: Shield, title: "交通执法", description: "辅助交通执法，监控违章行为，维护道路秩序" },
];
      ...
      <main className="pt-16 md:pt-20">
        <section className="relative h-[350px] md:h-[450px] overflow-hidden">
          ...
          <div className="relative container-custom h-full flex items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground mb-4">交通</h1>
        ...
        <section className="py-16 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">获取交通行业解决方案</h2>
