...
import { ArrowLeft, ArrowRight, CheckCircle, Phone, Mail, Box, Layers, Shield, Wind, Ruler, Wrench } from "lucide-react";
import { Link } from "react-router-dom";

const Airframe = () => {
  const features = [
    { icon: Box, title: "结构设计", description: "专业气动与结构设计" },
    { icon: Layers, title: "复合材料", description: "碳纤维复合材料工艺" },
    { icon: Shield, title: "高强度", description: "轻量化高强度设计" },
    { icon: Wind, title: "气动优化", description: "低阻高效气动外形" },
    { icon: Ruler, title: "尺寸定制", description: "按需定制机身尺寸" },
    { icon: Wrench, title: "快速迭代", description: "快速原型与迭代" },
  ];
  ...
  const cases = [
    {
      title: "防水机身定制",
      client: "某海洋研究所",
      description: "定制开发IP67防护等级机身，满足海上作业和恶劣天气需求。",
    },
    {
      title: "折叠便携机身",
      client: "某应急救援队",
      description: "设计可快速折叠收纳的机身结构，便于应急携带和快速部署。",
    },
    {
      title: "大载荷机身",
      client: "某测绘单位",
      description: "定制开发高强度碳纤维机身，满足20kg载荷需求。",
    },
  ];
      ...
      <main className="pt-16 md:pt-20">
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">机身定制</span>
            </div>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">机身定制</h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  提供专业的无人机机身定制服务，从结构设计到复合材料加工，满足各种特殊尺寸、载荷和环境防护需求。
                </p>
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=800&q=80" alt="机身定制" className="rounded-2xl shadow-2xl w-full" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-primary-foreground mb-6">开启机身定制项目</h2>
