...
const milestones = [
  { year: "2015", title: "公司成立", description: "长凌电子在湖南邵阳正式成立，开启无人机研发之路" },
...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="关于长凌"
        description="长凌电子有限公司成立于2015年，是一家专注于工业无人机研发、生产和销售的高新技术企业，拥有200+专业员工、50+发明专利。"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  长凌电子有限公司成立于2015年，是一家专注于工业无人机研发、生产和销售的高新技术企业。公司总部位于湖南邵阳，拥有完整的无人机产业链，从飞控系统、动力系统到整机制造均具备自主研发能力。
                </p>
                <p className="text-muted-foreground mb-4 leading-relaxed">
