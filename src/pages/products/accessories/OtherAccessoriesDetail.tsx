    ...
    <div className="min-h-screen">
      ...
      <main className="pt-16 md:pt-20">
        ...
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground flex-wrap">
              ...
              <span>/</span>
              <Link to="/products/accessories/others" className="hover:text-accent">其他配件</Link>
              <span>/</span>
        ...
        <section className="py-16 bg-background">
          <div className="container-custom">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">产品特性</h2>
        ...
        <section className="py-16 bg-secondary">
          <div className="container-custom">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">技术规格</h2>
