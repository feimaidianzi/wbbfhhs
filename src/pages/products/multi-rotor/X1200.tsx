...
const X1200 = () => {
  ...
  const features = [
    { icon: Camera, title: "重型载荷", description: "10kg支持专业级设备" },
    { icon: Settings, title: "多载荷", description: "支持多种专业载荷" },
    { icon: Shield, title: "极高可靠", description: "双冗余飞控系统" },
    { icon: Cpu, title: "智能系统", description: "AI智能识别" },
    { icon: Zap, title: "超长续航", description: "55分钟持续作业" },
    { icon: Wind, title: "超强抗风", description: "7级风稳定飞行" },
  ];

  const applications = ["专业测绘", "重型巡检", "应急救援", "科研探测", "农业植保", "环境监测"];
      ...
      <main className="pt-16 md:pt-20">
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">X1200多旋翼无人机</span>
            </div>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">X1200多旋翼无人机</h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  大型工业无人机，适用于重型载荷和长航时任务，是专业级应用的理想选择。55分钟超长续航，满足各种复杂任务需求。
                </p>
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1579829366248-204fe8413f31?w=800&q=80" alt="X1200多旋翼无人机" className="rounded-2xl shadow-2xl w-full" />
                <div className="absolute -bottom-6 -left-6 bg-accent text-accent-foreground px-6 py-3 rounded-xl shadow-lg">
                  <div className="text-2xl font-bold">10kg</div>
        ...
        <section className="py-20 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-primary-foreground mb-6">了解更多X1200解决方案</h2>
