...
const X1600 = () => {
  ...
  const features = [
    { icon: Camera, title: "超重载荷", description: "20kg支持特殊任务载荷" },
    { icon: Settings, title: "专业定制", description: "支持定制化配置" },
    { icon: Shield, title: "工业级", description: "满足严苛工业要求" },
    { icon: Cpu, title: "高精度", description: "RTK厘米级定位" },
    { icon: Zap, title: "大动力", description: "强劲动力系统" },
    { icon: Wind, title: "稳定性", description: "超大尺寸更稳定" },
  ];

  const applications = ["专业测绘", "物资运输", "特种作业", "科研实验", "重型航拍", "工业检测"];
      ...
      <main className="pt-16 md:pt-20">
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">X1600多旋翼无人机</span>
            </div>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">X1600多旋翼无人机</h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  超大型工业无人机，满足特殊行业的超重载荷需求。20kg最大载重，适用于专业测绘、物资运输等特殊场景。
                </p>
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=800&q=80" alt="X1600多旋翼无人机" className="rounded-2xl shadow-2xl w-full" />
        ...
        <section className="py-20 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-primary-foreground mb-6">了解更多X1600解决方案</h2>
