  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto mt-8">
            <p className="text-gray-300 mb-2 animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
            ...
            animationDelay: "0.2s"
              ...
              <div className="space-y-1">
                <div className="flex border-b border-gray-700 py-3">
                  <span className="text-gray-400 w-40 text-center">50米 / 100米高度可选，系留供电可实现12小时连续驻空清洗作业。</span>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-amber-500 mb-12 animate-fade-in" style={{
          animationDelay: "0.1s"
        }}>
            前方障碍物检测距离≥3米
          </p>
          ...
          animationDelay: "0.2s"
            ...
            <div className="relative">
              <img src={th100Radar} alt="相控阵雷达安全系统" className="w-full h-auto" />
