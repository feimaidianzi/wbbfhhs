...
const TH200 = () => {
  ...
  const features = [
    { icon: Clock, title: "长期部署", description: "适用于长时间持续任务" },
    { icon: Zap, title: "大功率供电", description: "3kW供电支持更多载荷" },
    { icon: Shield, title: "强抗风性", description: "7级风稳定作业" },
    { icon: Radio, title: "多载荷支持", description: "支持多种任务载荷" },
    { icon: Eye, title: "4K图传", description: "超高清实时视频" },
    { icon: Settings, title: "智能控制", description: "自动化运行管理" },
  ];
        ...
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">TH-200系留无人机</span>
            </div>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">TH-200系留无人机</h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  中型系留平台，具备更强的载荷能力和更高的升空高度，适用于长期部署场景。是大型活动安保、边境监视等重要任务的可靠选择。
                </p>
