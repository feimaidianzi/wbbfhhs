...
const WL10 = () => {
  ...
  const features = [
    { icon: Package, title: "轻量载荷", description: "10kg载重满足城市配送" },
    { icon: Truck, title: "快速配送", description: "30分钟内完成配送" },
    { icon: MapPin, title: "精准投递", description: "厘米级定位精度" },
    { icon: Timer, title: "高效运营", description: "智能航线规划" },
    { icon: Shield, title: "安全可靠", description: "多重安全保护" },
    { icon: Zap, title: "快速部署", description: "5分钟完成起飞准备" },
  ];

  const applications = ["城市最后一公里", "即时配送", "餐饮外卖", "医药配送", "电商快递", "文件急送"];
      ...
      <main className="pt-16 md:pt-20">
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">WL-10物流无人机</span>
            </div>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">WL-10物流无人机</h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  轻量级物流配送平台，适用于城市最后一公里配送场景。快速响应即时配送需求，是城市物流的理想选择。
                </p>
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=800&q=80" alt="WL-10物流无人机" className="rounded-2xl shadow-2xl w-full" />
        ...
        <section className="py-20 bg-primary">
          <div className="container-custom text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-primary-foreground mb-6">了解更多WL-10解决方案</h2>
