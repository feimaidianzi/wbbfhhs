...
const UHS400P = () => {
  ...
  const specs = [
    { labelKey: 'airport.uhs400p.spec.droneWeight', value: "≤15kg" },
    { labelKey: 'airport.uhs400p.spec.chargingPower', value: "400W" },
    { labelKey: 'airport.uhs400p.spec.chargingTime', value: "<35min" },
    { labelKey: 'airport.uhs400p.spec.totalWeight', value: "<50kg" },
    { labelKey: 'airport.uhs400p.spec.portableDesign', valueKey: 'airport.uhs400p.feature.portable' },
    { labelKey: 'airport.uhs400p.spec.protection', value: "IP65" },
    { labelKey: 'airport.uhs400p.spec.operatingTemp', value: "-20°C~50°C" },
    { labelKey: 'airport.uhs400p.spec.communication', value: "4G/5G" },
    { labelKey: 'airport.uhs400p.spec.deployTime', value: "<5min" },
  ];

  const features = [
    { icon: Briefcase, titleKey: 'airport.uhs400p.feature.portable', descKey: 'airport.uhs400p.feature.portable.desc' },
    { icon: Zap, titleKey: 'airport.uhs400p.feature.fastCharge', descKey: 'airport.uhs400p.feature.fastCharge.desc' },
    { icon: Cloud, titleKey: 'airport.uhs400p.feature.allWeather', descKey: 'airport.uhs400p.feature.allWeather.desc' },
    { icon: Wifi, titleKey: 'airport.uhs400p.feature.comm', descKey: 'airport.uhs400p.feature.comm.desc' },
    { icon: Shield, titleKey: 'airport.uhs400p.feature.safe', descKey: 'airport.uhs400p.feature.safe.desc' },
    { icon: Settings, titleKey: 'airport.uhs400p.feature.rapidDeploy', descKey: 'airport.uhs400p.feature.rapidDeploy.desc' },
  ];

  const applications = [
    'airport.uhs400p.app.tempInspection',
    'airport.uhs400p.app.emergency',
    'airport.uhs400p.app.fieldSurvey',
    'airport.uhs400p.app.tempSecurity',
    'airport.uhs400p.app.construction',
    'airport.uhs400p.app.eventSupport',
  ];

  return (
    <div className="min-h-screen">
      <MultiLanguageSEO title={t('airport.uhs400p.name')} description={t('airport.uhs400p.hero.desc')} keywords="UHS-400P,drone airport,无人机机场,小型无人机停机坪" path="/products/airport/uhs-400p" />
      <PageStructuredData data={{ type: 'Product', name: 'UHS-400P', description: t('airport.uhs400p.hero.desc'), category: 'Drone Airport System', sku: 'UHS-400P' }} />
      <Header />
        ...
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">{t('airport.uhs400p.name')}</span>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">
                  {t('airport.uhs400p.name')}
                </h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  {t('airport.uhs400p.hero')}
                </p>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-accent text-accent-foreground px-6 py-3 rounded-xl shadow-lg">
                  ...
                  <div className="text-sm">{t('airport.uhs400p.feature.portable')}</div>
                </div>
              </div>
            </div>
          </div>
