...
const UHS1000 = () => {
  ...
  const specs = [
    { labelKey: 'airport.uhs400p.spec.droneWeight', value: "≤50kg" },
    { labelKey: 'airport.uhs400p.spec.chargingPower', value: "1000W" },
    { labelKey: 'airport.uhs400p.spec.chargingTime', value: "<45min" },
    ...
    { labelKey: 'airport.uhs1000.spec.powerSupply', valueKey: 'airport.uhs1000.spec.powerSupply.value' },
    { labelKey: 'airport.uhs600.spec.footprint', value: "4m²" },
    { labelKey: 'airport.uhs600.spec.positionAccuracy', value: "±5cm (RTK)" },
  ];

  const features = [
    { icon: Battery, titleKey: 'airport.uhs1000.feature.highPower', descKey: 'airport.uhs1000.feature.highPower.desc' },
    { icon: Zap, titleKey: 'airport.uhs1000.feature.heavyLoad', descKey: 'airport.uhs1000.feature.heavyLoad.desc' },
    { icon: Cloud, titleKey: 'airport.uhs1000.feature.allWeatherOp', descKey: 'airport.uhs1000.feature.allWeatherOp.desc' },
    { icon: Wifi, titleKey: 'airport.uhs1000.feature.smartSchedule', descKey: 'airport.uhs1000.feature.smartSchedule.desc' },
    { icon: Shield, titleKey: 'airport.uhs1000.feature.safeReliable', descKey: 'airport.uhs1000.feature.safeReliable.desc' },
    { icon: Settings, titleKey: 'airport.uhs1000.feature.payloadChange', descKey: 'airport.uhs1000.feature.payloadChange.desc' },
  ];

  const applications = [
    'airport.uhs1000.app.largeSolar',
    'airport.uhs1000.app.uhvLine',
    'airport.uhs1000.app.industrialPark',
    'airport.uhs1000.app.portTerminal',
    'airport.uhs1000.app.miningSafety',
    'airport.uhs1000.app.largeReservoir',
  ];

  return (
    <div className="min-h-screen">
      <MultiLanguageSEO title={t('airport.uhs1000.name')} description={t('airport.uhs1000.hero.desc')} keywords="UHS-1000,drone airport,无人机机场,大型无人机停机坪" path="/products/airport/uhs-1000" />
      <PageStructuredData data={{ type: 'Product', name: 'UHS-1000', description: t('airport.uhs1000.hero.desc'), category: 'Drone Airport System', sku: 'UHS-1000' }} />
      <Header />
        ...
        <div className="bg-secondary py-4">
          <div className="container-custom">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">{t('airport.uhs1000.name')}</span>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-6">
                  {t('airport.uhs1000.name')}
                </h1>
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  {t('airport.uhs1000.hero')}
                </p>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-accent text-accent-foreground px-6 py-3 rounded-xl shadow-lg">
                  ...
                  <div className="text-sm">{t('airport.uhs400p.spec.chargingPower')}</div>
                </div>
              </div>
            </div>
          </div>
