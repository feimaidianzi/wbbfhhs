...
export const separateEscProducts: FcEscProduct[] = [
  ...
  },
  {
    ...
    name: "CANI 100A 单体工业电调",
    model: "CANI Separate ESC 100A (6-12S / 120A 峰值 / 独立 CNC 散热)",
    category: "分体电调",
    hot: true,
    ...
    price: "¥289",
    highlights: [
      "单路 100A 持续 / 120A 峰值 (10s)，巅峰动力单元",
      "6-12S LiPo 超高压支持 (22.2V - 50.4V)",
      "一体化 CNC 7系航空铝合金散热外壳",
      "独立安装设计，分布式物理故障隔离",
      "工业级三防漆涂层（防腐蚀/防盐雾/防尘）",
      "DShot300/600 + PWM + Telemetry 实时遥测回传"
    ],
    description: [
      "CANI 100A 单体电调是一款巅峰性能的分布式动力单元。专为特种大载重无人机、VTOL 及 12S 系统量身打造，支持单路 100A 持续输出与 120A 瞬时爆发。凭借独立式 CNC 散热外壳、极低内阻工业级组件以及三防防护工艺，在极端恶劣环境下提供无可比拟的动力稳定性。",
      "12S 超高压架构相比 6S 可将电流减半，在输出相同推力时发热量大幅降低，为 TH-300 系留无人机等连续数十小时工作的平台提供更宽裕的热冗余。配合 FC-F722 飞控的高频调度，实现极其细腻的姿态补偿。",
      "每个单体电调采用 7 系航空铝 CNC 切削散热外壳，利用螺旋桨下洗气流主动散热，冷却效率远超四合一方案。独立逻辑控制电路配专用光耦隔离，有效防止 100A 大电流切换产生的电磁噪声冲击飞控，为 FV10W-72 数字图传营造纯净电磁环境。",
      "支持独立 Telemetry 遥测回传，飞手可精准识别每个轴位电机的健康状态。采用行业顶级低内阻 MOSFET 和高耐压电容阵列，从容应对 12S 紧急制动时的巨大反向电动势。是构建重型 VTOL、X8 共轴冗余及系留无人机分布式动力链路的终极选择。"
    ],
    escSpecs: {
      current: "100A (单路独立持续)",
      peakCurrent: "120A (峰值 10s)",
      voltage: "6-12S LiPo (22.2V - 50.4V)",
      protocol: "DShot600/300, PWM, Telemetry",
      mosfet: "顶级低内阻工业 MOSFET + 高耐压电容阵列",
      pcbLayers: "加厚铜箔 PCB + 光耦隔离逻辑电路",
      size: "40×22mm (紧凑条状，适配工业机臂)",
      weight: "18g/个 (含 CNC 散热壳)"
    },
    features: [
      "分布式独立安装，物理层面故障隔离",
      "一体化 CNC 7系航空铝合金散热外壳",
      "12S 超高压支持，电流减半效率翻倍",
      "顶级低内阻 MOSFET + 高耐压电容阵列",
      "光耦隔离逻辑电路，EMI 大幅抑制",
      "工业级三防漆涂层（防腐蚀/防盐雾/防尘）",
      "独立 Telemetry 遥测（电流/电压/转速/温度）",
      "适配重型 VTOL、X8、系留机等分布式架构"
    ],
    notes: [
      "推荐适配重型 VTOL、X8 架构及系留无人机",
      "12S 系统请确保电池放电倍率 ≥50C",
      "大电流使用建议 8AWG 以上硅胶线",
      "海上作业建议定期检查三防涂层完整性"
    ],
