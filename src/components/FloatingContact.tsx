  ...
  return (
    <>
      ...
      <div className="fixed right-4 bottom-24 z-30 flex flex-col gap-1.5">
        ...
        <a
          href="https://wa.me/8617674048404"
          target="_blank"
        ...
        <a
          href="https://instagram.com/868163685410"
          target="_blank"
          rel="noopener noreferrer"
          className="w-9 h-9 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-full shadow-md flex items-center justify-center text-white hover:opacity-90 transition-opacity"
          title="Instagram"
        >
