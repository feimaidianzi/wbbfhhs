  ...
  const specs = {
    drone: {
      ...
      items: [
        ...
        { label: isZh ? "最大起飞重量" : "Max Takeoff Weight", value: "4kg" },
        { label: isZh ? "最长飞行时间" : "Max Flight Time", value: "30min", highlight: true },
        ...
        { label: isZh ? "电池" : "Battery", value: "6S 10000mAh LiPo (22.2V / 222Wh)", highlight: true },
      ],
    },
    power: {
