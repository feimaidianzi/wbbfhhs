  ...
  return (
    <div className="absolute inset-0 z-0">
      ...
      >
        ...
        <AnimatedSphere position={[-3, 1, -2]} scale={1.2} color="#22d3ee" speed={0.3} />
        <AnimatedSphere position={[3, -1, -3]} scale={0.8} color="#0ea5e9" speed={0.5} />
        <AnimatedSphere position={[0, 2, -4]} scale={0.6} color="#06b6d4" speed={0.4} />
